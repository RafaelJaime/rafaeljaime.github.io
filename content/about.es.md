...
<div style="max-width: 700px; margin: 0 auto; padding-left: 1.5rem; position: relative; color: var(--content);">
  ...
  <div style="position: relative; margin-bottom: 2.5rem; z-index: 1;">
    <time style="display: inline-block; font-size: 1rem; color: var(--secondary); margin-bottom: 0.5rem; font-weight: 500;">2026 – Actualidad</time>
    <h3 style="color: var(--primary); margin: 0 0 0.3rem 0; font-size: 1.3rem; font-weight: 500; line-height: 1.3;">Desarrollador de Software — Harmonia</h3>
    <p style="color: var(--secondary); margin: 0; font-size: 0.95rem; font-style: italic;">PopCoach — App basada en IA para ayudar a las personas en su vida laboral y personal · React Native, Expo, TypeScript, Supabase</p>
  </div>
